...
@Path("/ccapplicationapproval")
@org.eclipse.microprofile.openapi.annotations.tags.Tag(name = "ccapplicationapproval")
@jakarta.enterprise.context.ApplicationScoped()
public class CcapplicationapprovalResource {

    @jakarta.inject.Inject()
    @jakarta.inject.Named("ccapplicationapproval")
    Process<CcapplicationapprovalModel> process;
    ...
    @Operation(summary = "ccapplicationapproval", description = "")
    public Response createResource_ccapplicationapproval(@Context HttpHeaders httpHeaders, @Context UriInfo uriInfo, @QueryParam("businessKey") @DefaultValue("") String businessKey, @jakarta.validation.Valid() @jakarta.validation.constraints.NotNull() CcapplicationapprovalModelInput resource) {
        ProcessInstance<CcapplicationapprovalModel> pi = processService.createProcessInstance(process, businessKey, Optional.ofNullable(resource).orElse(new CcapplicationapprovalModelInput()).toModel(), httpHeaders.getRequestHeaders(), httpHeaders.getHeaderString("X-KOGITO-StartFromNode"));
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "ccapplicationapproval", description = "")
    public List<CcapplicationapprovalModelOutput> getResources_ccapplicationapproval() {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "ccapplicationapproval", description = "")
    public Map<String, Object> getResourceSchema_ccapplicationapproval() {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "ccapplicationapproval", description = "")
    public CcapplicationapprovalModelOutput getResource_ccapplicationapproval(@PathParam("id") String id) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "ccapplicationapproval", description = "")
    public CcapplicationapprovalModelOutput deleteResource_ccapplicationapproval(@PathParam("id") final String id) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "ccapplicationapproval", description = "")
    public CcapplicationapprovalModelOutput updateModel_ccapplicationapproval(@PathParam("id") String id, @jakarta.validation.Valid() @jakarta.validation.constraints.NotNull() CcapplicationapprovalModelInput resource) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "ccapplicationapproval", description = "")
    public CcapplicationapprovalModelOutput updateModelPartial_ccapplicationapproval(@PathParam("id") String id, @jakarta.validation.Valid() @jakarta.validation.constraints.NotNull() CcapplicationapprovalModelInput resource) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "ccapplicationapproval", description = "")
    public List<TaskModel> getTasks_ccapplicationapproval(@PathParam("id") String id, @QueryParam("user") final String user, @QueryParam("group") final List<String> groups) {
        return processService.getTasks(process, id, SecurityPolicy.of(IdentityProviders.of(user, groups))).orElseThrow(NotFoundException::new).stream().map(com.example.Ccapplicationapproval_TaskModelFactory::from).collect(Collectors.toList());
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public CcapplicationapprovalModelOutput signal_0(@PathParam("id") final String id) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public CcapplicationapprovalModelOutput completeTask_reviewApplication_1(@PathParam("id") final String id, @PathParam("taskId") final String taskId, @QueryParam("phase") @DefaultValue("complete") final String phase, @QueryParam("user") final String user, @QueryParam("group") final List<String> groups, final com.example.Ccapplicationapproval__305326C0_3480_4026_AD6E_0B00F19159B0_TaskOutput model) {
    ...
    @Path("/{id}/reviewApplication/{taskId}")
    @Consumes(MediaType.APPLICATION_JSON)
    public com.example.Ccapplicationapproval__305326C0_3480_4026_AD6E_0B00F19159B0_TaskOutput saveTask_reviewApplication_1(@PathParam("id") final String id, @PathParam("taskId") final String taskId, @QueryParam("user") final String user, @QueryParam("group") final List<String> groups, final com.example.Ccapplicationapproval__305326C0_3480_4026_AD6E_0B00F19159B0_TaskOutput model) {
        return processService.saveTask(process, id, taskId, SecurityPolicy.of(user, groups), model, com.example.Ccapplicationapproval__305326C0_3480_4026_AD6E_0B00F19159B0_TaskOutput::fromMap).orElseThrow(NotFoundException::new);
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public CcapplicationapprovalModelOutput taskTransition_reviewApplication_1(@PathParam("id") final String id, @PathParam("taskId") final String taskId, @PathParam("phase") final String phase, @QueryParam("user") final String user, @QueryParam("group") final List<String> groups, final com.example.Ccapplicationapproval__305326C0_3480_4026_AD6E_0B00F19159B0_TaskOutput model) {
        return processService.taskTransition(process, id, taskId, phase, SecurityPolicy.of(user, groups), model).orElseThrow(NotFoundException::new);
    }
    ...
    @Path("/{id}/reviewApplication/{taskId}")
    @Produces(MediaType.APPLICATION_JSON)
    public com.example.Ccapplicationapproval__305326C0_3480_4026_AD6E_0B00F19159B0_TaskModel getTask_reviewApplication_1(@PathParam("id") String id, @PathParam("taskId") String taskId, @QueryParam("user") final String user, @QueryParam("group") final List<String> groups) {
        return processService.getTask(process, id, taskId, SecurityPolicy.of(user, groups), com.example.Ccapplicationapproval__305326C0_3480_4026_AD6E_0B00F19159B0_TaskModel::from).orElseThrow(NotFoundException::new);
    }

    @DELETE
    @Path("/{id}/reviewApplication/{taskId}")
    @Produces(MediaType.APPLICATION_JSON)
    public CcapplicationapprovalModelOutput abortTask_reviewApplication_1(@PathParam("id") final String id, @PathParam("taskId") final String taskId, @QueryParam("phase") @DefaultValue("abort") final String phase, @QueryParam("user") final String user, @QueryParam("group") final List<String> groups) {
