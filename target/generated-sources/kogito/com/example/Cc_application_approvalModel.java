...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "cc_application_approval", name = "Cc_application_approval", hidden = false)
public class Cc_application_approvalModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<Cc_application_approvalModelOutput> {
    ...
    @Override()
    public Cc_application_approvalModelOutput toModel() {
        Cc_application_approvalModelOutput result = new Cc_application_approvalModelOutput();
        result.setId(getId());
