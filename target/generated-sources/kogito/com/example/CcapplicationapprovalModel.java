...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "ccapplicationapproval", name = "Ccapplicationapproval", hidden = false)
public class CcapplicationapprovalModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<CcapplicationapprovalModelOutput> {
    ...
    @Override()
    public CcapplicationapprovalModelOutput toModel() {
        CcapplicationapprovalModelOutput result = new CcapplicationapprovalModelOutput();
        result.setId(getId());
